...
var EnvatoWizard = (function($){
    ...
    function window_loaded(){
        ...
        $('.theme-presets a.dsvy-theme-preset-thumbnail').on( 'click', function(e) {
            e.preventDefault();
        ...
        // Set title
        jQuery(document).prop('title', jQuery('#dsvy-title').text() ); 
    ...
    function renderMediaUploader() {
        ...
        file_frame.on( 'select', function() {
            ...
            var img = new Image();
            img.onload = function() {
                jQuery('#dsvy-swizard-global-color-pallate, #dsvy-swizard-secondary-color-pallate').html('');
                
                jQuery('.dsvy-logo-section-right').each(function(){
                ...
                for (var swatch in swatches){
                    if (swatches.hasOwnProperty(swatch) && swatches[swatch]){
                        ...
                        }).appendTo('#dsvy-swizard-global-color-pallate, #dsvy-swizard-secondary-color-pallate');

                        if( set_globalcolor == false ){
                            jQuery('#dsvy-swizard-globalcolor').iris('color', swatches[swatch].getHex() );
                            set_globalcolor = true;
                        }
                        if( set_secondarycolor == false && x==2 ){
                            jQuery('#dsvy-swizard-secondarycolor').iris('color', swatches[swatch].getHex() );
                ...
                // now apply click 
                var bgcolor_primary = '';
                jQuery('#dsvy-swizard-global-color-pallate > div').on('click', function(e){
                    bgcolor_primary = jQuery(this).css('background-color');
                    jQuery('#dsvy-swizard-globalcolor').iris({ 'color': true } );
                    jQuery('#dsvy-swizard-globalcolor').iris({ mode: 'rgb' } );
                    jQuery('#dsvy-swizard-globalcolor').iris({ 'color': bgcolor_primary } );
                });

                var bgcolor_secondary = '';
                jQuery('#dsvy-swizard-secondary-color-pallate > div').on('click', function(e){
                    bgcolor_secondary = jQuery(this).css('background-color');
                    jQuery('#dsvy-swizard-secondarycolor').iris({ 'color': true } );
                    jQuery('#dsvy-swizard-secondarycolor').iris({ mode: 'rgb' } );
                    jQuery('#dsvy-swizard-secondarycolor').iris({ 'color': bgcolor_secondary } );
                });
