 ...
 */
class DSVY_BlogElement extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'dsvy_blog_element';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'Lyfpro Blog Element', 'lyfpro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'from_category',
			[
				'label' => esc_attr__( 'Show Post from selected Blog Category?', 'lyfpro' ),
		...
		$this->add_control(
			'sortable',
			[
				'label' => esc_attr__( 'Show Sortable Blog Category ?', 'lyfpro' ),
				'description' => esc_attr__( 'Select YES to show sortable Blog Category.', 'lyfpro' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'lyfpro' ),
				'label_off' => esc_attr__( 'No', 'lyfpro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Blog View Style', 'lyfpro' ),
				'description'	=> esc_attr__( 'Slect Blog View style.', 'lyfpro' ),
				'type'			=> 'dsvy_imgselect',
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> '1',
				'options'		=> dsvy_element_template_list( 'blog', true ),
		...
		if ( $posts->have_posts() ) {
			...
			<div class="dsvy-ele-header-area">
				...
				if( function_exists('dsvy_sortable_category') ){
					$sortable_html = dsvy_sortable_category( $settings, 'category' );
...
Plugin::instance()->widgets_manager->register_widget_type( new DSVY_BlogElement() );